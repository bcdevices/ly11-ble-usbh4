...
func Test_Frames(t *testing.T) {
	d := &fh4{
		data: [][]byte{
			{0x04, 0x0e, 0x04, 0x01, 0x06, 0x20, 0x00},
			{0x04, 0x3e, 0x21, 0x02, 0x01, 0x00, 0x00, 0x92, 0x8a, 0x07, 0x0c, 0xda, 0xf8, 0x15, 0x02, 0x01, 0x02, 0x11, 0x07, 0xfc, 0x9d, 0xd0, 0xb3, 0xcb, 0x84, 0xe0, 0x84, 0x06, 0x42, 0xf3, 0xf7},
			{
